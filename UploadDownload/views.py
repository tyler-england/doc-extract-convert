...
def handle_upload(request, file_name_ext):
    ...
    for i in range(len(lineitems_array) - 1):  # for every line item
        ...
        lineitems_array[i]=str(lineitems_array[i]).replace("\\xa0"," ").strip()#remove... this
    ...
    xlsheet.set_column(3, 6, None, marker_format)
    xlsheet.set_column(7, 8, 40, note_format)
    ...
    xlsheet.write(0,6,"N/A")
    xlsheet.write(0, 7, "PSA Notes", note_head_format)
    xlsheet.write(0, 8, "Customer Notes", note_head_format)
